...
class UserPolicy:
    ...
    Attributes:
        ...
        max_parental_sub_rating (Union[None, Unset, int]):
        blocked_tags (Union[None, Unset, list[str]]):
        allowed_tags (Union[None, Unset, list[str]]):
        enable_user_preference_access (Union[Unset, bool]):
        access_schedules (Union[None, Unset, list['AccessSchedule']]):
        block_unrated_items (Union[None, Unset, list[UnratedItem]]):
        ...
        enable_content_deletion_from_folders (Union[None, Unset, list[str]]):
        ...
        enabled_devices (Union[None, Unset, list[str]]):
        enable_all_devices (Union[Unset, bool]):
        enabled_channels (Union[None, Unset, list[UUID]]):
        enable_all_channels (Union[Unset, bool]):
        enabled_folders (Union[None, Unset, list[UUID]]):
        ...
        blocked_media_folders (Union[None, Unset, list[UUID]]):
        blocked_channels (Union[None, Unset, list[UUID]]):
    ...
    max_parental_sub_rating: Union[None, Unset, int] = UNSET
    blocked_tags: Union[None, Unset, list[str]] = UNSET
    allowed_tags: Union[None, Unset, list[str]] = UNSET
    enable_user_preference_access: Union[Unset, bool] = UNSET
    access_schedules: Union[None, Unset, list["AccessSchedule"]] = UNSET
    block_unrated_items: Union[None, Unset, list[UnratedItem]] = UNSET
    ...
    enable_content_deletion_from_folders: Union[None, Unset, list[str]] = UNSET
    ...
    enabled_devices: Union[None, Unset, list[str]] = UNSET
    enable_all_devices: Union[Unset, bool] = UNSET
    enabled_channels: Union[None, Unset, list[UUID]] = UNSET
    enable_all_channels: Union[Unset, bool] = UNSET
    enabled_folders: Union[None, Unset, list[UUID]] = UNSET
    ...
    blocked_media_folders: Union[None, Unset, list[UUID]] = UNSET
    blocked_channels: Union[None, Unset, list[UUID]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        access_schedules: Union[None, Unset, list[dict[str, Any]]]
        ...
        block_unrated_items: Union[None, Unset, list[str]]
        ...
        enabled_channels: Union[None, Unset, list[str]]
        ...
        enabled_folders: Union[None, Unset, list[str]]
        ...
        blocked_media_folders: Union[None, Unset, list[str]]
        ...
        blocked_channels: Union[None, Unset, list[str]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_max_parental_sub_rating(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blocked_tags(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_allowed_tags(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_access_schedules(
            data: object,
        ) -> Union[None, Unset, list["AccessSchedule"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_block_unrated_items(
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list[UnratedItem]], data)
        ...
        def _parse_enabled_devices(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enabled_channels(data: object) -> Union[None, Unset, list[UUID]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enabled_folders(data: object) -> Union[None, Unset, list[UUID]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blocked_media_folders(
            data: object,
        ) -> Union[None, Unset, list[UUID]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blocked_channels(data: object) -> Union[None, Unset, list[UUID]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
