...
T = TypeVar("T", bound="PluginInstallationCancelledMessage")
...
class PluginInstallationCancelledMessage:
    ...
    Attributes:
        ...
        message_type (Union[Unset, SessionMessageType]): The different kinds of messages that are used in the WebSocket
            api. Default: SessionMessageType.PACKAGEINSTALLATIONCANCELLED.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plugin_installation_cancelled_message = cls(
            data=data,
            message_id=message_id,
            message_type=message_type,
        )

        return plugin_installation_cancelled_message
