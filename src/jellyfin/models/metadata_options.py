...
class MetadataOptions:
    ...
    Attributes:
        ...
        disabled_metadata_savers (Union[None, Unset, list[str]]):
        local_metadata_reader_order (Union[None, Unset, list[str]]):
        disabled_metadata_fetchers (Union[None, Unset, list[str]]):
        metadata_fetcher_order (Union[None, Unset, list[str]]):
        disabled_image_fetchers (Union[None, Unset, list[str]]):
        image_fetcher_order (Union[None, Unset, list[str]]):
    """

    item_type: Union[None, Unset, str] = UNSET
    disabled_metadata_savers: Union[None, Unset, list[str]] = UNSET
    local_metadata_reader_order: Union[None, Unset, list[str]] = UNSET
    disabled_metadata_fetchers: Union[None, Unset, list[str]] = UNSET
    metadata_fetcher_order: Union[None, Unset, list[str]] = UNSET
    disabled_image_fetchers: Union[None, Unset, list[str]] = UNSET
