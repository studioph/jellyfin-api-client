...
T = TypeVar("T", bound="SyncPlayUserJoinedUpdate")
...
class SyncPlayUserJoinedUpdate:
    ...
    Attributes:
        ...
        type_ (Union[Unset, GroupUpdateType]): Enum GroupUpdateType. Default: GroupUpdateType.USERJOINED.
    """

    group_id: Union[Unset, UUID] = UNSET
    data: Union[Unset, str] = UNSET
    type_: Union[Unset, GroupUpdateType] = GroupUpdateType.USERJOINED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_play_user_joined_update = cls(
            group_id=group_id,
            data=data,
            type_=type_,
        )

        return sync_play_user_joined_update
