...
T = TypeVar("T", bound="MediaSourceInfoRequiredHttpHeadersType0")


@_attrs_define
class MediaSourceInfoRequiredHttpHeadersType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        media_source_info_required_http_headers_type_0.additional_properties = (
            additional_properties
        )
        return media_source_info_required_http_headers_type_0
