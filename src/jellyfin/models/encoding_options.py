...
class EncodingOptions:
    ...
    Attributes:
        ...
        segment_keep_seconds (Union[Unset, int]): Gets or sets seconds for which segments should be kept before being
            deleted.
        hardware_acceleration_type (Union[Unset, HardwareAccelerationType]): Enum containing hardware acceleration
            types.
        ...
        qsv_device (Union[None, Unset, str]): Gets or sets the QSV device.
        ...
        tonemapping_algorithm (Union[Unset, TonemappingAlgorithm]): Enum containing tonemapping algorithms.
        tonemapping_mode (Union[Unset, TonemappingMode]): Enum containing tonemapping modes.
        tonemapping_range (Union[Unset, TonemappingRange]): Enum containing tonemapping ranges.
        ...
        encoder_preset (Union[Unset, EncodingOptionsEncoderPreset]): Gets or sets the encoder preset.
        deinterlace_double_rate (Union[Unset, bool]): Gets or sets a value indicating whether the framerate is doubled
            when deinterlacing.
        deinterlace_method (Union[Unset, DeinterlaceMethod]): Enum containing deinterlace methods.
        ...
        enable_decoding_color_depth_10_vp_9 (Union[Unset, bool]): Gets or sets a value indicating whether 10bit VP9
            decoding is enabled.
        enable_decoding_color_depth_10_hevc_rext (Union[Unset, bool]): Gets or sets a value indicating whether 8/10bit
            HEVC RExt decoding is enabled.
        enable_decoding_color_depth_12_hevc_rext (Union[Unset, bool]): Gets or sets a value indicating whether 12bit
            HEVC RExt decoding is enabled.
        ...
        enable_subtitle_extraction (Union[Unset, bool]): Gets or sets a value indicating whether subtitle extraction is
            enabled.
        hardware_decoding_codecs (Union[None, Unset, list[str]]): Gets or sets the codecs hardware encoding is used for.
        allow_on_demand_metadata_based_keyframe_extraction_for_extensions (Union[None, Unset, list[str]]): Gets or sets
    ...
    hardware_acceleration_type: Union[Unset, HardwareAccelerationType] = UNSET
    ...
    qsv_device: Union[None, Unset, str] = UNSET
    ...
    tonemapping_algorithm: Union[Unset, TonemappingAlgorithm] = UNSET
    tonemapping_mode: Union[Unset, TonemappingMode] = UNSET
    tonemapping_range: Union[Unset, TonemappingRange] = UNSET
    ...
    encoder_preset: Union[Unset, EncodingOptionsEncoderPreset] = UNSET
    deinterlace_double_rate: Union[Unset, bool] = UNSET
    deinterlace_method: Union[Unset, DeinterlaceMethod] = UNSET
    enable_decoding_color_depth_10_hevc: Union[Unset, bool] = UNSET
    enable_decoding_color_depth_10_vp_9: Union[Unset, bool] = UNSET
    enable_decoding_color_depth_10_hevc_rext: Union[Unset, bool] = UNSET
    enable_decoding_color_depth_12_hevc_rext: Union[Unset, bool] = UNSET
    ...
    hardware_decoding_codecs: Union[None, Unset, list[str]] = UNSET
    allow_on_demand_metadata_based_keyframe_extraction_for_extensions: Union[
        None, Unset, list[str]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        qsv_device: Union[None, Unset, str]
        ...
        encoder_preset: Union[Unset, str] = UNSET
        ...
        deinterlace_method: Union[Unset, str] = UNSET
        ...
        hardware_decoding_codecs: Union[None, Unset, list[str]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hardware_acceleration_type: Union[Unset, HardwareAccelerationType]
        ...
        def _parse_qsv_device(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        tonemapping_algorithm: Union[Unset, TonemappingAlgorithm]
        ...
        tonemapping_mode: Union[Unset, TonemappingMode]
        ...
        tonemapping_range: Union[Unset, TonemappingRange]
        ...
        encoder_preset: Union[Unset, EncodingOptionsEncoderPreset]
        ...
        deinterlace_method: Union[Unset, DeinterlaceMethod]
        ...
        def _parse_hardware_decoding_codecs(
            data: object,
