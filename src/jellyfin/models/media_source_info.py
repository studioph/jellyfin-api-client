...
class MediaSourceInfo:
    ...
    Attributes:
        ...
        type_ (Union[Unset, MediaSourceType]):
        ...
        use_most_compatible_transcoding_profile (Union[Unset, bool]):  Default: False.
        ...
        media_streams (Union[None, Unset, list['MediaStream']]):
        media_attachments (Union[None, Unset, list['MediaAttachment']]):
        formats (Union[None, Unset, list[str]]):
        bitrate (Union[None, Unset, int]):
        fallback_max_streaming_bitrate (Union[None, Unset, int]):
    ...
    type_: Union[Unset, MediaSourceType] = UNSET
    ...
    use_most_compatible_transcoding_profile: Union[Unset, bool] = False
    ...
    media_attachments: Union[None, Unset, list["MediaAttachment"]] = UNSET
    formats: Union[None, Unset, list[str]] = UNSET
    bitrate: Union[None, Unset, int] = UNSET
    fallback_max_streaming_bitrate: Union[None, Unset, int] = UNSET
    ...
    has_segments: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        media_attachments: Union[None, Unset, list[dict[str, Any]]]
        ...
        required_http_headers: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_media_attachments(
            data: object,
        ) -> Union[None, Unset, list["MediaAttachment"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["MediaAttachment"]], data)

        media_attachments = _parse_media_attachments(d.pop("MediaAttachments", UNSET))

        def _parse_formats(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_fallback_max_streaming_bitrate(
            data: object,
