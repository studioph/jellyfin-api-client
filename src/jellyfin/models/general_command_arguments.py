...
T = TypeVar("T", bound="GeneralCommandArguments")


@_attrs_define
class GeneralCommandArguments:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        general_command_arguments.additional_properties = additional_properties
        return general_command_arguments
