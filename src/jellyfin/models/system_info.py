...
class SystemInfo:
    ...
    Attributes:
        ...
        completed_installations (Union[None, Unset, list['InstallationInfo']]): Gets or sets the completed
            installations.
        ...
        cast_receiver_applications (Union[None, Unset, list['CastReceiverApplication']]): Gets or sets the list of cast
    ...
    completed_installations: Union[None, Unset, list["InstallationInfo"]] = UNSET
    ...
    cast_receiver_applications: Union[None, Unset, list["CastReceiverApplication"]] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        completed_installations: Union[None, Unset, list[dict[str, Any]]]
        ...
        cast_receiver_applications: Union[None, Unset, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_operating_system_display_name(
            data: object,
        ...
        def _parse_completed_installations(
            data: object,
        ) -> Union[None, Unset, list["InstallationInfo"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["InstallationInfo"]], data)
        ...
        def _parse_cast_receiver_applications(
            data: object,
        ) -> Union[None, Unset, list["CastReceiverApplication"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["CastReceiverApplication"]], data)
