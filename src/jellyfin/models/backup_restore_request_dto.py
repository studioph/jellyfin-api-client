...
class BackupRestoreRequestDto:
    ...
    Attributes:
        archive_file_name (Union[Unset, str]): Gets or Sets the name of the backup archive to restore from. Must be
            present in MediaBrowser.Common.Configuration.IApplicationPaths.BackupPath.
    """
