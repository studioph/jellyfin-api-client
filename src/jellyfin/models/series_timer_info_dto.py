...
class SeriesTimerInfoDto:
    ...
    Attributes:
        ...
        channel_id (Union[Unset, UUID]): Gets or sets the channel id of the recording.
        ...
        days (Union[None, Unset, list[DayOfWeek]]): Gets or sets the days.
    ...
    days: Union[None, Unset, list[DayOfWeek]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_days(data: object) -> Union[None, Unset, list[DayOfWeek]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
