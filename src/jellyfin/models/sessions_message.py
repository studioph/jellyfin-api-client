...
class SessionsMessage:
    ...
    Attributes:
        data (Union[None, Unset, list['SessionInfoDto']]): Gets or sets the data.
    ...
    data: Union[None, Unset, list["SessionInfoDto"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list["SessionInfoDto"]]:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = SessionInfoDto.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["SessionInfoDto"]], data)
