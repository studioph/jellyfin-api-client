...
T = TypeVar("T", bound="ScheduledTasksInfoMessage")
...
class ScheduledTasksInfoMessage:
    ...
    Attributes:
        data (Union[None, Unset, list['TaskInfo']]): Gets or sets the data.
        ...
        message_type (Union[Unset, SessionMessageType]): The different kinds of messages that are used in the WebSocket
            api. Default: SessionMessageType.SCHEDULEDTASKSINFO.
    """

    data: Union[None, Unset, list["TaskInfo"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list["TaskInfo"]]:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = TaskInfo.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["TaskInfo"]], data)
        ...
        scheduled_tasks_info_message = cls(
            data=data,
            message_id=message_id,
            message_type=message_type,
        )

        return scheduled_tasks_info_message
