...
class SongInfo:
    ...
    Attributes:
        ...
        provider_ids (Union['SongInfoProviderIdsType0', None, Unset]): Gets or sets the provider ids.
        ...
        album_artists (Union[None, Unset, list[str]]):
    ...
    provider_ids: Union["SongInfoProviderIdsType0", None, Unset] = UNSET
    ...
    album_artists: Union[None, Unset, list[str]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_ids(
            data: object,
        ) -> Union["SongInfoProviderIdsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["SongInfoProviderIdsType0", None, Unset], data)
        ...
        def _parse_album_artists(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
