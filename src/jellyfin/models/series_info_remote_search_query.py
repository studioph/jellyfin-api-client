...
if TYPE_CHECKING:
    from ..models.series_info import SeriesInfo


T = TypeVar("T", bound="SeriesInfoRemoteSearchQuery")
...
class SeriesInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (Union['SeriesInfo', None, Unset]):
    ...
    search_info: Union["SeriesInfo", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.search_info, Unset):
            search_info = UNSET
        elif isinstance(self.search_info, SeriesInfo):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> Union["SeriesInfo", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                search_info_type_1 = SeriesInfo.from_dict(data)

                return search_info_type_1
            except:  # noqa: E722
                pass
            return cast(Union["SeriesInfo", None, Unset], data)
        ...
        series_info_remote_search_query = cls(
        ...
        return series_info_remote_search_query
