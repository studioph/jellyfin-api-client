...
if TYPE_CHECKING:
    from ..models.media_segment_dto import MediaSegmentDto


T = TypeVar("T", bound="MediaSegmentDtoQueryResult")
...
class MediaSegmentDtoQueryResult:
    ...
    Attributes:
        items (Union[Unset, list['MediaSegmentDto']]): Gets or sets the items.
    ...
    items: Union[Unset, list["MediaSegmentDto"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = MediaSegmentDto.from_dict(items_item_data)
        ...
        media_segment_dto_query_result = cls(
            items=items,
            total_record_count=total_record_count,
            start_index=start_index,
        )

        return media_segment_dto_query_result
