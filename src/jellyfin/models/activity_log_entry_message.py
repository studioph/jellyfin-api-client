...
class ActivityLogEntryMessage:
    ...
    Attributes:
        data (Union[None, Unset, list['ActivityLogEntry']]): Gets or sets the data.
    ...
    data: Union[None, Unset, list["ActivityLogEntry"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, Unset, list["ActivityLogEntry"]]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list["ActivityLogEntry"]], data)
