...
class ExternalIdInfo:
    ...
    Attributes:
        ...
        key (Union[Unset, str]): Gets or sets the unique key for this id. This key should be unique across all
            providers.
        type_ (Union[Unset, ExternalIdInfoType]): Gets or sets the specific media type for this id. This is used to
    ...
    type_: Union[Unset, ExternalIdInfoType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, ExternalIdInfoType]
