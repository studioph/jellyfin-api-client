...
class SystemStorageDto:
    ...
    Attributes:
        program_data_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        web_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        image_cache_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        cache_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        log_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        internal_metadata_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        transcoding_temp_folder (Union[Unset, FolderStorageDto]): Contains information about a specific folder.
        libraries (Union[Unset, list['LibraryStorageDto']]): Gets or sets the storage informations of all libraries.
    """

    program_data_folder: Union[Unset, "FolderStorageDto"] = UNSET
    web_folder: Union[Unset, "FolderStorageDto"] = UNSET
    image_cache_folder: Union[Unset, "FolderStorageDto"] = UNSET
    cache_folder: Union[Unset, "FolderStorageDto"] = UNSET
    log_folder: Union[Unset, "FolderStorageDto"] = UNSET
    internal_metadata_folder: Union[Unset, "FolderStorageDto"] = UNSET
    transcoding_temp_folder: Union[Unset, "FolderStorageDto"] = UNSET
    libraries: Union[Unset, list["LibraryStorageDto"]] = UNSET

    def to_dict(self) -> dict[str, Any]:
        program_data_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.program_data_folder, Unset):
            program_data_folder = self.program_data_folder.to_dict()

        web_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.web_folder, Unset):
            web_folder = self.web_folder.to_dict()

        image_cache_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.image_cache_folder, Unset):
            image_cache_folder = self.image_cache_folder.to_dict()

        cache_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.cache_folder, Unset):
            cache_folder = self.cache_folder.to_dict()

        log_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.log_folder, Unset):
            log_folder = self.log_folder.to_dict()

        internal_metadata_folder: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.internal_metadata_folder, Unset):
            internal_metadata_folder = self.internal_metadata_folder.to_dict()

        transcoding_temp_folder: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        web_folder: Union[Unset, FolderStorageDto]
        ...
        image_cache_folder: Union[Unset, FolderStorageDto]
        ...
        cache_folder: Union[Unset, FolderStorageDto]
        ...
        log_folder: Union[Unset, FolderStorageDto]
        ...
        internal_metadata_folder: Union[Unset, FolderStorageDto]
        ...
        transcoding_temp_folder: Union[Unset, FolderStorageDto]
