...
class DeviceProfile:
    ...
    transcode to</see> in case it isn't.
        ...
        Attributes:
            name (Union[None, Unset, str]): Gets or sets the name of this device profile. User profiles must have a unique
                name.
            id (Union[None, UUID, Unset]): Gets or sets the unique internal identifier.
            ...
            container_profiles (Union[Unset, list['ContainerProfile']]): Gets or sets the container profiles. Failing to
                meet these optional conditions causes transcoding to occur.
