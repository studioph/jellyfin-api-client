...
class SubtitleOptions:
    ...
    Attributes:
        ...
        download_languages (Union[None, Unset, list[str]]):
    ...
    download_languages: Union[None, Unset, list[str]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_download_languages(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
        ...
        def _parse_open_subtitles_password_hash(
            data: object,
