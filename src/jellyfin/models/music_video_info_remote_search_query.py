...
class MusicVideoInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (Union['MusicVideoInfo', None, Unset]):
    ...
    search_info: Union["MusicVideoInfo", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.search_info, Unset):
            search_info = UNSET
        elif isinstance(self.search_info, MusicVideoInfo):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> Union["MusicVideoInfo", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                search_info_type_1 = MusicVideoInfo.from_dict(data)

                return search_info_type_1
            except:  # noqa: E722
                pass
            return cast(Union["MusicVideoInfo", None, Unset], data)
