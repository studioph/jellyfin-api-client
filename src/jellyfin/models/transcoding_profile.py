...
class TranscodingProfile:
    ...
    override values defined here.
        ...
        Attributes:
            ...
            video_codec (Union[Unset, str]): Gets or sets the video codec.
            audio_codec (Union[Unset, str]): Gets or sets the audio codec.
            protocol (Union[Unset, MediaStreamProtocol]): Media streaming protocol.
                Lowercase for backwards compatibility.
            estimate_content_length (Union[Unset, bool]): Gets or sets a value indicating whether the content length should
                be estimated. Default: False.
            enable_mpegts_m2_ts_mode (Union[Unset, bool]): Gets or sets a value indicating whether M2TS mode is enabled.
                Default: False.
            transcode_seek_info (Union[Unset, TranscodeSeekInfo]):  Default: TranscodeSeekInfo.AUTO.
            copy_timestamps (Union[Unset, bool]): Gets or sets a value indicating whether timestamps should be copied.
                Default: False.
            context (Union[Unset, EncodingContext]):  Default: EncodingContext.STREAMING.
            enable_subtitles_in_manifest (Union[Unset, bool]): Gets or sets a value indicating whether subtitles are allowed
                in the manifest. Default: False.
            max_audio_channels (Union[None, Unset, str]): Gets or sets the maximum audio channels.
            min_segments (Union[Unset, int]): Gets or sets the minimum amount of segments. Default: 0.
            segment_length (Union[Unset, int]): Gets or sets the segment length. Default: 0.
            break_on_non_key_frames (Union[Unset, bool]): Gets or sets a value indicating whether breaking the video stream
                on non-keyframes is supported. Default: False.
            conditions (Union[Unset, list['ProfileCondition']]): Gets or sets the profile conditions.
            enable_audio_vbr_encoding (Union[Unset, bool]): Gets or sets a value indicating whether variable bitrate
                encoding is supported. Default: True.
    """
