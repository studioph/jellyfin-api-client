...
class RemoveFromPlaylistRequestDto:
    ...
    Attributes:
        playlist_item_ids (Union[Unset, list[UUID]]): Gets or sets the playlist identifiers of the items. Ignored when
    ...
    playlist_item_ids: Union[Unset, list[UUID]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for playlist_item_ids_item_data in _playlist_item_ids or []:
