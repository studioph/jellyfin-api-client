...
class ServerConfiguration:
    ...
    Attributes:
        ...
        cache_size (Union[Unset, int]): Gets or sets the maximum amount of items to cache.
        ...
        enable_grouping_movies_into_collections (Union[Unset, bool]):
        enable_grouping_shows_into_collections (Union[Unset, bool]):
        ...
        dummy_chapter_duration (Union[Unset, int]): Gets or sets the dummy chapter duration in seconds, use 0 (zero) or
            less to disable generation altogether.
        ...
        enable_legacy_authorization (Union[Unset, bool]): Gets or sets a value indicating whether old authorization
            methods are allowed.
    """
    ...
    enable_grouping_movies_into_collections: Union[Unset, bool] = UNSET
    enable_grouping_shows_into_collections: Union[Unset, bool] = UNSET
    ...
    enable_legacy_authorization: Union[Unset, bool] = UNSET
