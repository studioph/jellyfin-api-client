...
T = TypeVar("T", bound="SeriesTimerCancelledMessage")
...
class SeriesTimerCancelledMessage:
    ...
    Attributes:
        ...
        message_type (Union[Unset, SessionMessageType]): The different kinds of messages that are used in the WebSocket
            api. Default: SessionMessageType.SERIESTIMERCANCELLED.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        series_timer_cancelled_message = cls(
            data=data,
            message_id=message_id,
            message_type=message_type,
        )

        return series_timer_cancelled_message
