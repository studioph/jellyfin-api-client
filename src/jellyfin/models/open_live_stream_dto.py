...
class OpenLiveStreamDto:
    ...
    Attributes:
        ...
        user_id (Union[None, UUID, Unset]): Gets or sets the user id.
        ...
        item_id (Union[None, UUID, Unset]): Gets or sets the item id.
        ...
        enable_direct_stream (Union[None, Unset, bool]): Gets or sets a value indicating whether to enable direct
            stream.
        always_burn_in_subtitle_when_transcoding (Union[None, Unset, bool]): Gets or sets a value indicating whether
    ...
    item_id: Union[None, UUID, Unset] = UNSET
    enable_direct_play: Union[None, Unset, bool] = UNSET
    enable_direct_stream: Union[None, Unset, bool] = UNSET
    always_burn_in_subtitle_when_transcoding: Union[None, Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        always_burn_in_subtitle_when_transcoding: Union[None, Unset, bool]
        ...
        device_profile: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_item_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
