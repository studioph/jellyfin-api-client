...
if TYPE_CHECKING:
    from ..models.music_video_info_provider_ids_type_0 import (
        MusicVideoInfoProviderIdsType0,
    )


T = TypeVar("T", bound="MusicVideoInfo")
...
class MusicVideoInfo:
    ...
    Attributes:
        ...
        provider_ids (Union['MusicVideoInfoProviderIdsType0', None, Unset]): Gets or sets the provider ids.
    ...
    provider_ids: Union["MusicVideoInfoProviderIdsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.provider_ids, Unset):
            provider_ids = UNSET
        elif isinstance(self.provider_ids, MusicVideoInfoProviderIdsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_ids(
            data: object,
        ) -> Union["MusicVideoInfoProviderIdsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_ids_type_0 = MusicVideoInfoProviderIdsType0.from_dict(data)

                return provider_ids_type_0
            except:  # noqa: E722
                pass
            return cast(Union["MusicVideoInfoProviderIdsType0", None, Unset], data)
