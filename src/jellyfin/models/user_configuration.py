...
class UserConfiguration:
    ...
    Attributes:
        ...
        grouped_folders (Union[Unset, list[UUID]]):
        ...
        ordered_views (Union[Unset, list[UUID]]):
        latest_items_excludes (Union[Unset, list[UUID]]):
        my_media_excludes (Union[Unset, list[UUID]]):
    ...
    grouped_folders: Union[Unset, list[UUID]] = UNSET
    ...
    ordered_views: Union[Unset, list[UUID]] = UNSET
    latest_items_excludes: Union[Unset, list[UUID]] = UNSET
    my_media_excludes: Union[Unset, list[UUID]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for grouped_folders_item_data in _grouped_folders or []:
        ...
        for ordered_views_item_data in _ordered_views or []:
        ...
        for latest_items_excludes_item_data in _latest_items_excludes or []:
        ...
        for my_media_excludes_item_data in _my_media_excludes or []:
