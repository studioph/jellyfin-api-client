...
class AllThemeMediaResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        theme_videos_result: Union[None, Unset, dict[str, Any]]
        ...
        theme_songs_result: Union[None, Unset, dict[str, Any]]
        ...
        soundtrack_songs_result: Union[None, Unset, dict[str, Any]]
