...
class BaseItemPerson:
    ...
    Attributes:
        ...
        id (Union[Unset, UUID]): Gets or sets the identifier.
        role (Union[None, Unset, str]): Gets or sets the role.
        type_ (Union[Unset, PersonKind]): The person kind. Default: PersonKind.UNKNOWN.
    ...
    type_: Union[Unset, PersonKind] = PersonKind.UNKNOWN
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_image_blur_hashes(
            data: object,
        ) -> Union["BaseItemPersonImageBlurHashesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
