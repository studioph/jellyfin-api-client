...
T = TypeVar("T", bound="ScheduledTaskEndedMessage")
...
class ScheduledTaskEndedMessage:
    ...
    Attributes:
        data (Union['TaskResult', None, Unset]): Class TaskExecutionInfo.
        ...
        message_type (Union[Unset, SessionMessageType]): The different kinds of messages that are used in the WebSocket
            api. Default: SessionMessageType.SCHEDULEDTASKENDED.
    """

    data: Union["TaskResult", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, TaskResult):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union["TaskResult", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_1 = TaskResult.from_dict(data)
        ...
        scheduled_task_ended_message = cls(
            data=data,
            message_id=message_id,
            message_type=message_type,
        )

        return scheduled_task_ended_message
