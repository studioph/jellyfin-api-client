...
class BaseItemDto:
    ...
    This holds information about a BaseItem in a format that is convenient for the client.
        ...
        Attributes:
            ...
            id (Union[Unset, UUID]): Gets or sets the id.
            ...
            external_urls (Union[None, Unset, list['ExternalUrl']]): Gets or sets the external urls.
            media_sources (Union[None, Unset, list['MediaSourceInfo']]): Gets or sets the media versions.
            critic_rating (Union[None, Unset, float]): Gets or sets the critic rating.
            production_locations (Union[None, Unset, list[str]]):
            ...
            channel_id (Union[None, UUID, Unset]): Gets or sets the channel identifier.
            channel_name (Union[None, Unset, str]):
            overview (Union[None, Unset, str]): Gets or sets the overview.
            taglines (Union[None, Unset, list[str]]): Gets or sets the taglines.
            genres (Union[None, Unset, list[str]]): Gets or sets the genres.
            ...
            remote_trailers (Union[None, Unset, list['MediaUrl']]): Gets or sets the trailer urls.
            ...
            parent_id (Union[None, UUID, Unset]): Gets or sets the parent id.
            type_ (Union[Unset, BaseItemKind]): The base item kind.
            people (Union[None, Unset, list['BaseItemPerson']]): Gets or sets the people.
            studios (Union[None, Unset, list['NameGuidPair']]): Gets or sets the studios.
            genre_items (Union[None, Unset, list['NameGuidPair']]):
            parent_logo_item_id (Union[None, UUID, Unset]): Gets or sets whether the item has a logo, this will hold the Id
                of the Parent that has one.
            parent_backdrop_item_id (Union[None, UUID, Unset]): Gets or sets whether the item has any backdrops, this will
                hold the Id of the Parent that has one.
            parent_backdrop_image_tags (Union[None, Unset, list[str]]): Gets or sets the parent backdrop image tags.
            ...
            series_id (Union[None, UUID, Unset]): Gets or sets the series id.
            season_id (Union[None, UUID, Unset]): Gets or sets the season identifier.
            ...
            air_days (Union[None, Unset, list[DayOfWeek]]): Gets or sets the air days.
            tags (Union[None, Unset, list[str]]): Gets or sets the tags.
            primary_image_aspect_ratio (Union[None, Unset, float]): Gets or sets the primary image aspect ratio, after image
                enhancements.
            artists (Union[None, Unset, list[str]]): Gets or sets the artists.
            artist_items (Union[None, Unset, list['NameGuidPair']]): Gets or sets the artist items.
            ...
            album_id (Union[None, UUID, Unset]): Gets or sets the album id.
            ...
            album_artists (Union[None, Unset, list['NameGuidPair']]): Gets or sets the album artists.
            season_name (Union[None, Unset, str]): Gets or sets the name of the season.
            media_streams (Union[None, Unset, list['MediaStream']]): Gets or sets the media streams.
            ...
            backdrop_image_tags (Union[None, Unset, list[str]]): Gets or sets the backdrop image tags.
            screenshot_image_tags (Union[None, Unset, list[str]]): Gets or sets the screenshot image tags.
            parent_logo_image_tag (Union[None, Unset, str]): Gets or sets the parent logo image tag.
            parent_art_item_id (Union[None, UUID, Unset]): Gets or sets whether the item has fan art, this will hold the Id
                of the Parent that has one.
            ...
            parent_thumb_item_id (Union[None, UUID, Unset]): Gets or sets the parent thumb item id.
            parent_thumb_image_tag (Union[None, Unset, str]): Gets or sets the parent thumb image tag.
            parent_primary_image_item_id (Union[None, UUID, Unset]): Gets or sets the parent primary image item identifier.
            parent_primary_image_tag (Union[None, Unset, str]): Gets or sets the parent primary image tag.
            chapters (Union[None, Unset, list['ChapterInfo']]): Gets or sets the chapters.
            ...
            media_type (Union[Unset, MediaType]): Media types. Default: MediaType.UNKNOWN.
            end_date (Union[None, Unset, datetime.datetime]): Gets or sets the end date.
            locked_fields (Union[None, Unset, list[MetadataField]]): Gets or sets the locked fields.
    ...
    external_urls: Union[None, Unset, list["ExternalUrl"]] = UNSET
    media_sources: Union[None, Unset, list["MediaSourceInfo"]] = UNSET
    critic_rating: Union[None, Unset, float] = UNSET
    production_locations: Union[None, Unset, list[str]] = UNSET
    ...
    taglines: Union[None, Unset, list[str]] = UNSET
    ...
    remote_trailers: Union[None, Unset, list["MediaUrl"]] = UNSET
    ...
    type_: Union[Unset, BaseItemKind] = UNSET
    people: Union[None, Unset, list["BaseItemPerson"]] = UNSET
    studios: Union[None, Unset, list["NameGuidPair"]] = UNSET
    genre_items: Union[None, Unset, list["NameGuidPair"]] = UNSET
    parent_logo_item_id: Union[None, UUID, Unset] = UNSET
    parent_backdrop_item_id: Union[None, UUID, Unset] = UNSET
    parent_backdrop_image_tags: Union[None, Unset, list[str]] = UNSET
    ...
    series_id: Union[None, UUID, Unset] = UNSET
    ...
    air_days: Union[None, Unset, list[DayOfWeek]] = UNSET
    tags: Union[None, Unset, list[str]] = UNSET
    primary_image_aspect_ratio: Union[None, Unset, float] = UNSET
    artists: Union[None, Unset, list[str]] = UNSET
    artist_items: Union[None, Unset, list["NameGuidPair"]] = UNSET
    ...
    album_id: Union[None, UUID, Unset] = UNSET
    ...
    album_artists: Union[None, Unset, list["NameGuidPair"]] = UNSET
    season_name: Union[None, Unset, str] = UNSET
    media_streams: Union[None, Unset, list["MediaStream"]] = UNSET
    ...
    backdrop_image_tags: Union[None, Unset, list[str]] = UNSET
    screenshot_image_tags: Union[None, Unset, list[str]] = UNSET
    parent_logo_image_tag: Union[None, Unset, str] = UNSET
    parent_art_item_id: Union[None, UUID, Unset] = UNSET
    ...
    parent_thumb_item_id: Union[None, UUID, Unset] = UNSET
    parent_thumb_image_tag: Union[None, Unset, str] = UNSET
    parent_primary_image_item_id: Union[None, UUID, Unset] = UNSET
    parent_primary_image_tag: Union[None, Unset, str] = UNSET
    chapters: Union[None, Unset, list["ChapterInfo"]] = UNSET
    ...
    media_type: Union[Unset, MediaType] = MediaType.UNKNOWN
    end_date: Union[None, Unset, datetime.datetime] = UNSET
    locked_fields: Union[None, Unset, list[MetadataField]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        external_urls: Union[None, Unset, list[dict[str, Any]]]
        ...
        media_sources: Union[None, Unset, list[dict[str, Any]]]
        ...
        taglines: Union[None, Unset, list[str]]
        ...
        remote_trailers: Union[None, Unset, list[dict[str, Any]]]
        ...
        provider_ids: Union[None, Unset, dict[str, Any]]
        ...
        people: Union[None, Unset, list[dict[str, Any]]]
        ...
        studios: Union[None, Unset, list[dict[str, Any]]]
        ...
        genre_items: Union[None, Unset, list[dict[str, Any]]]
        ...
        parent_backdrop_image_tags: Union[None, Unset, list[str]]
        ...
        user_data: Union[None, Unset, dict[str, Any]]
        ...
        air_days: Union[None, Unset, list[str]]
        ...
        artists: Union[None, Unset, list[str]]
        ...
        artist_items: Union[None, Unset, list[dict[str, Any]]]
        ...
        album_artists: Union[None, Unset, list[dict[str, Any]]]
        ...
        media_streams: Union[None, Unset, list[dict[str, Any]]]
        ...
        image_tags: Union[None, Unset, dict[str, Any]]
        ...
        backdrop_image_tags: Union[None, Unset, list[str]]
        ...
        screenshot_image_tags: Union[None, Unset, list[str]]
        ...
        image_blur_hashes: Union[None, Unset, dict[str, Any]]
        ...
        chapters: Union[None, Unset, list[dict[str, Any]]]
        ...
        trickplay: Union[None, Unset, dict[str, Any]]
        ...
        locked_fields: Union[None, Unset, list[str]]
        ...
        current_program: Union[None, Unset, dict[str, Any]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_external_urls(
            data: object,
        ) -> Union[None, Unset, list["ExternalUrl"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["ExternalUrl"]], data)

        external_urls = _parse_external_urls(d.pop("ExternalUrls", UNSET))

        def _parse_media_sources(
            data: object,
        ) -> Union[None, Unset, list["MediaSourceInfo"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["MediaSourceInfo"]], data)
        ...
        def _parse_production_locations(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_taglines(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_remote_trailers(
            data: object,
        ) -> Union[None, Unset, list["MediaUrl"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["MediaUrl"]], data)
        ...
        type_: Union[Unset, BaseItemKind]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = BaseItemKind(_type_)

        def _parse_people(data: object) -> Union[None, Unset, list["BaseItemPerson"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["BaseItemPerson"]], data)

        people = _parse_people(d.pop("People", UNSET))

        def _parse_studios(data: object) -> Union[None, Unset, list["NameGuidPair"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_genre_items(
            data: object,
        ) -> Union[None, Unset, list["NameGuidPair"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_logo_item_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_backdrop_item_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_series_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_air_days(data: object) -> Union[None, Unset, list[DayOfWeek]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_artists(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_album_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_media_streams(
            data: object,
        ) -> Union[None, Unset, list["MediaStream"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["MediaStream"]], data)
        ...
        def _parse_backdrop_image_tags(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_screenshot_image_tags(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_art_item_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_thumb_item_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_chapters(data: object) -> Union[None, Unset, list["ChapterInfo"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["ChapterInfo"]], data)
        ...
        def _parse_locked_fields(
            data: object,
        ) -> Union[None, Unset, list[MetadataField]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list[MetadataField]], data)
