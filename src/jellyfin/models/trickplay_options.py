...
class TrickplayOptions:
    ...
    Attributes:
        ...
        enable_hw_encoding (Union[Unset, bool]): Gets or sets a value indicating whether or not to use HW accelerated
            MJPEG encoding.
        enable_key_frame_only_extraction (Union[Unset, bool]): Gets or sets a value indicating whether to only extract
            key frames.
    ...
    enable_key_frame_only_extraction: Union[Unset, bool] = UNSET
