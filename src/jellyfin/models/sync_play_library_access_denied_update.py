...
T = TypeVar("T", bound="SyncPlayLibraryAccessDeniedUpdate")
...
class SyncPlayLibraryAccessDeniedUpdate:
    ...
    Attributes:
        ...
        type_ (Union[Unset, GroupUpdateType]): Enum GroupUpdateType. Default: GroupUpdateType.LIBRARYACCESSDENIED.
    """

    group_id: Union[Unset, UUID] = UNSET
    data: Union[Unset, str] = UNSET
    type_: Union[Unset, GroupUpdateType] = GroupUpdateType.LIBRARYACCESSDENIED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_play_library_access_denied_update = cls(
            group_id=group_id,
            data=data,
            type_=type_,
        )

        return sync_play_library_access_denied_update
