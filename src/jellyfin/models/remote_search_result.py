...
class RemoteSearchResult:
    ...
    Attributes:
        ...
        artists (Union[None, Unset, list['RemoteSearchResult']]):
    """
    ...
    artists: Union[None, Unset, list["RemoteSearchResult"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        album_artist: Union[None, Unset, dict[str, Any]]
        ...
        artists: Union[None, Unset, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_artists(
            data: object,
        ) -> Union[None, Unset, list["RemoteSearchResult"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["RemoteSearchResult"]], data)
