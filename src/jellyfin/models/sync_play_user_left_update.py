...
T = TypeVar("T", bound="SyncPlayUserLeftUpdate")
...
class SyncPlayUserLeftUpdate:
    ...
    Attributes:
        ...
        type_ (Union[Unset, GroupUpdateType]): Enum GroupUpdateType. Default: GroupUpdateType.USERLEFT.
    """

    group_id: Union[Unset, UUID] = UNSET
    data: Union[Unset, str] = UNSET
    type_: Union[Unset, GroupUpdateType] = GroupUpdateType.USERLEFT
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_play_user_left_update = cls(
            group_id=group_id,
            data=data,
            type_=type_,
        )

        return sync_play_user_left_update
