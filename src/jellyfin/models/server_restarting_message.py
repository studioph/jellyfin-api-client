...
T = TypeVar("T", bound="ServerRestartingMessage")
...
class ServerRestartingMessage:
    ...
    Attributes:
        ...
        message_type (Union[Unset, SessionMessageType]): The different kinds of messages that are used in the WebSocket
            api. Default: SessionMessageType.SERVERRESTARTING.
    """

    message_id: Union[Unset, UUID] = UNSET
    message_type: Union[Unset, SessionMessageType] = SessionMessageType.SERVERRESTARTING
