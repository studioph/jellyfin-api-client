...
T = TypeVar("T", bound="BaseItemDtoProviderIdsType0")


@_attrs_define
class BaseItemDtoProviderIdsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_item_dto_provider_ids_type_0.additional_properties = additional_properties
        return base_item_dto_provider_ids_type_0
