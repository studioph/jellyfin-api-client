...
class TaskInfo:
    ...
    Attributes:
        ...
        triggers (Union[None, Unset, list['TaskTriggerInfo']]): Gets or sets the triggers.
    ...
    triggers: Union[None, Unset, list["TaskTriggerInfo"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_execution_result: Union[None, Unset, dict[str, Any]]
        ...
        triggers: Union[None, Unset, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_triggers(
            data: object,
        ) -> Union[None, Unset, list["TaskTriggerInfo"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, Unset, list["TaskTriggerInfo"]], data)
