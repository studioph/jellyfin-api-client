...
class LibraryOptions:
    ...
    Attributes:
        ...
        save_trickplay_with_media (Union[Unset, bool]):  Default: False.
        disabled_lyric_fetchers (Union[Unset, list[str]]):
        lyric_fetcher_order (Union[Unset, list[str]]):
        prefer_nonstandard_artists_tag (Union[Unset, bool]):  Default: False.
        use_custom_tag_delimiters (Union[Unset, bool]):  Default: False.
        custom_tag_delimiters (Union[Unset, list[str]]):
        delimiter_whitelist (Union[Unset, list[str]]):
    ...
    metadata_savers: Union[None, Unset, list[str]] = UNSET
    disabled_local_metadata_readers: Union[Unset, list[str]] = UNSET
    local_metadata_reader_order: Union[None, Unset, list[str]] = UNSET
    disabled_subtitle_fetchers: Union[Unset, list[str]] = UNSET
    subtitle_fetcher_order: Union[Unset, list[str]] = UNSET
    disabled_media_segment_providers: Union[Unset, list[str]] = UNSET
    media_segment_provider_order: Union[Unset, list[str]] = UNSET
    ...
    subtitle_download_languages: Union[None, Unset, list[str]] = UNSET
    ...
    save_trickplay_with_media: Union[Unset, bool] = False
    disabled_lyric_fetchers: Union[Unset, list[str]] = UNSET
    lyric_fetcher_order: Union[Unset, list[str]] = UNSET
    prefer_nonstandard_artists_tag: Union[Unset, bool] = False
    use_custom_tag_delimiters: Union[Unset, bool] = False
    custom_tag_delimiters: Union[Unset, list[str]] = UNSET
    delimiter_whitelist: Union[Unset, list[str]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata_savers(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
