...
class SyncPlayGroupUpdateMessage:
    ...
    Attributes:
        data (Union['SyncPlayGroupDoesNotExistUpdate', 'SyncPlayGroupJoinedUpdate', 'SyncPlayGroupLeftUpdate',
            'SyncPlayLibraryAccessDeniedUpdate', 'SyncPlayNotInGroupUpdate', 'SyncPlayPlayQueueUpdate',
            'SyncPlayStateUpdate', 'SyncPlayUserJoinedUpdate', 'SyncPlayUserLeftUpdate', Unset]): Represents the list of
            possible group update types
