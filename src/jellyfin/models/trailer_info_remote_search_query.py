...
if TYPE_CHECKING:
    from ..models.trailer_info import TrailerInfo


T = TypeVar("T", bound="TrailerInfoRemoteSearchQuery")
...
class TrailerInfoRemoteSearchQuery:
    """
    Attributes:
        search_info (Union['TrailerInfo', None, Unset]):
    ...
    search_info: Union["TrailerInfo", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.search_info, Unset):
            search_info = UNSET
        elif isinstance(self.search_info, TrailerInfo):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_search_info(data: object) -> Union["TrailerInfo", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                search_info_type_1 = TrailerInfo.from_dict(data)

                return search_info_type_1
            except:  # noqa: E722
                pass
            return cast(Union["TrailerInfo", None, Unset], data)
        ...
        trailer_info_remote_search_query = cls(
        ...
        return trailer_info_remote_search_query
