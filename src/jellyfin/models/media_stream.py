...
class MediaStream:
    ...
    Attributes:
        ...
        dv_bl_signal_compatibility_id (Union[None, Unset, int]): Gets or sets the Dolby Vision bl signal compatibility
            id.
        rotation (Union[None, Unset, int]): Gets or sets the Rotation in degrees.
        ...
        hdr_10_plus_present_flag (Union[None, Unset, bool]):
        video_range (Union[Unset, VideoRange]): An enum representing video ranges. Default: VideoRange.UNKNOWN.
        video_range_type (Union[Unset, VideoRangeType]): An enum representing types of video ranges. Default:
        ...
        reference_frame_rate (Union[None, Unset, float]): Gets the framerate used as reference.
            Prefer AverageFrameRate, if that is null or an unrealistic value
            then fallback to RealFrameRate.
        profile (Union[None, Unset, str]): Gets or sets the profile.
        type_ (Union[Unset, MediaStreamType]): Enum MediaStreamType.
    ...
    rotation: Union[None, Unset, int] = UNSET
    comment: Union[None, Unset, str] = UNSET
    time_base: Union[None, Unset, str] = UNSET
    codec_time_base: Union[None, Unset, str] = UNSET
    title: Union[None, Unset, str] = UNSET
    hdr_10_plus_present_flag: Union[None, Unset, bool] = UNSET
    video_range: Union[Unset, VideoRange] = VideoRange.UNKNOWN
    video_range_type: Union[Unset, VideoRangeType] = VideoRangeType.UNKNOWN
    ...
    reference_frame_rate: Union[None, Unset, float] = UNSET
    profile: Union[None, Unset, str] = UNSET
    type_: Union[Unset, MediaStreamType] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        reference_frame_rate: Union[None, Unset, float]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_dv_bl_signal_compatibility_id(
            data: object,
        ...
        def _parse_rotation(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_hdr_10_plus_present_flag(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_reference_frame_rate(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        type_: Union[Unset, MediaStreamType]
