...
class TranscodingInfo:
    ...
    Attributes:
        audio_codec (Union[None, Unset, str]): Gets or sets the thread count used for encoding.
        video_codec (Union[None, Unset, str]): Gets or sets the thread count used for encoding.
        container (Union[None, Unset, str]): Gets or sets the thread count used for encoding.
        is_video_direct (Union[Unset, bool]): Gets or sets a value indicating whether the video is passed through.
        is_audio_direct (Union[Unset, bool]): Gets or sets a value indicating whether the audio is passed through.
        bitrate (Union[None, Unset, int]): Gets or sets the bitrate.
        framerate (Union[None, Unset, float]): Gets or sets the framerate.
        completion_percentage (Union[None, Unset, float]): Gets or sets the completion percentage.
        width (Union[None, Unset, int]): Gets or sets the video width.
        height (Union[None, Unset, int]): Gets or sets the video height.
        audio_channels (Union[None, Unset, int]): Gets or sets the audio channels.
        hardware_acceleration_type (Union[Unset, TranscodingInfoHardwareAccelerationType]): Gets or sets the hardware
            acceleration type.
        transcode_reasons (Union[Unset, TranscodingInfoTranscodeReasons]): Gets or sets the transcode reasons.
    """
