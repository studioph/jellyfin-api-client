...
class TunerHostInfo:
    ...
    Attributes:
        ...
        allow_fmp_4_transcoding_container (Union[Unset, bool]):
        allow_stream_sharing (Union[Unset, bool]):
        fallback_max_streaming_bitrate (Union[Unset, int]):
    ...
    allow_fmp_4_transcoding_container: Union[Unset, bool] = UNSET
    allow_stream_sharing: Union[Unset, bool] = UNSET
    fallback_max_streaming_bitrate: Union[Unset, int] = UNSET
