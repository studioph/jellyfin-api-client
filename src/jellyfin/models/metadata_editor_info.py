...
class MetadataEditorInfo:
    ...
    Attributes:
        parental_rating_options (Union[Unset, list['ParentalRating']]): Gets or sets the parental rating options.
        countries (Union[Unset, list['CountryInfo']]): Gets or sets the countries.
        cultures (Union[Unset, list['CultureDto']]): Gets or sets the cultures.
        external_id_infos (Union[Unset, list['ExternalIdInfo']]): Gets or sets the external id infos.
        content_type (Union[Unset, MetadataEditorInfoContentType]): Gets or sets the content type.
        content_type_options (Union[Unset, list['NameValuePair']]): Gets or sets the content type options.
    """
