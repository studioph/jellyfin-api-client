...
def _get_kwargs(
    ...
    language: str,
    *,
    is_perfect_match: Union[Unset, bool] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[Any, ProblemDetails, list["RemoteSubtitleInfo"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProblemDetails, list["RemoteSubtitleInfo"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ProblemDetails, list['RemoteSubtitleInfo']]
    """
