...
from ...models.head_audio_stream_by_container_stream_options import (
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "HeadAudioStreamByContainerStreamOptions"] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, HeadAudioStreamByContainerStreamOptions]):
