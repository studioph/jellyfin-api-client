...
from ...models.head_audio_stream_stream_options import HeadAudioStreamStreamOptions
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "HeadAudioStreamStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "head",
        "url": "/Audio/{item_id}/stream".format(
            item_id=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, HeadAudioStreamStreamOptions]):
