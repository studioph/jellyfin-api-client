...
from ...models.head_video_stream_stream_options import HeadVideoStreamStreamOptions
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "HeadVideoStreamStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "head",
        "url": "/Videos/{item_id}/stream".format(
            item_id=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, HeadVideoStreamStreamOptions]):
