...
from ...models.get_video_stream_stream_options import GetVideoStreamStreamOptions
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "GetVideoStreamStreamOptions"] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, GetVideoStreamStreamOptions]):
