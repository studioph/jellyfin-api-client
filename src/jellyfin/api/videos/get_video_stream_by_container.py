...
from ...models.get_video_stream_by_container_stream_options import (
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "GetVideoStreamByContainerStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/Videos/{item_id}/stream.{container}".format(
            item_id=item_id,
            container=container,
        ),
        "params": params,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, GetVideoStreamByContainerStreamOptions]):
