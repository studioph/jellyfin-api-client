...
) -> Optional[Union[Any, ProblemDetails, list["SpecialViewOptionDto"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProblemDetails, list["SpecialViewOptionDto"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ProblemDetails, list['SpecialViewOptionDto']]
    """
