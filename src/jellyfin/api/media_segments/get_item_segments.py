...
def _get_kwargs(
    item_id: UUID,
    *,
    include_segment_types: Union[Unset, list[MediaSegmentType]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    json_include_segment_types: Union[Unset, list[str]] = UNSET
...
) -> Optional[Union[Any, MediaSegmentDtoQueryResult, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, MediaSegmentDtoQueryResult, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        item_id (UUID):
        include_segment_types (Union[Unset, list[MediaSegmentType]]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, MediaSegmentDtoQueryResult, ProblemDetails]
    """
