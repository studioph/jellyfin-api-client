...
def _get_kwargs(
    ...
    *,
    runtime_ticks: int,
    actual_segment_length_ticks: int,
    ...
    stream_options: Union[Unset, "GetHlsVideoSegmentStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/Videos/{item_id}/hls1/{playlist_id}/{segment_id}.{container}".format(
            item_id=item_id,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, GetHlsVideoSegmentStreamOptions]):
