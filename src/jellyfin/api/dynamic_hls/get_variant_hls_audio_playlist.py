...
from ...models.get_variant_hls_audio_playlist_stream_options import (
...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "GetVariantHlsAudioPlaylistStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/Audio/{item_id}/main.m3u8".format(
            item_id=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, GetVariantHlsAudioPlaylistStreamOptions]):
