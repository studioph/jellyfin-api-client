...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "HeadMasterHlsVideoPlaylistStreamOptions"] = UNSET,
    enable_adaptive_bitrate_streaming: Union[Unset, bool] = False,
    enable_trickplay: Union[Unset, bool] = True,
    enable_audio_vbr_encoding: Union[Unset, bool] = True,
    always_burn_in_subtitle_when_transcoding: Union[Unset, bool] = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, HeadMasterHlsVideoPlaylistStreamOptions]):
        enable_adaptive_bitrate_streaming (Union[Unset, bool]):  Default: False.
        enable_trickplay (Union[Unset, bool]):  Default: True.
        enable_audio_vbr_encoding (Union[Unset, bool]):  Default: True.
        always_burn_in_subtitle_when_transcoding (Union[Unset, bool]):  Default: False.
