...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "HeadMasterHlsAudioPlaylistStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "head",
        "url": "/Audio/{item_id}/master.m3u8".format(
            item_id=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, HeadMasterHlsAudioPlaylistStreamOptions]):
