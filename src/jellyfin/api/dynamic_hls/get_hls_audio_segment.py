...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, "GetHlsAudioSegmentStreamOptions"] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/Audio/{item_id}/hls1/{playlist_id}/{segment_id}.{container}".format(
            item_id=item_id,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, GetHlsAudioSegmentStreamOptions]):
