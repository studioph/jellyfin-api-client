...
) -> Optional[Union[Any, PlaylistUserPermissions, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PlaylistUserPermissions, ProblemDetails]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, PlaylistUserPermissions, ProblemDetails]
    """
