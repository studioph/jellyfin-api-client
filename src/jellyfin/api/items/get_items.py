...
def _get_kwargs(
    *,
    ...
    index_number: Union[Unset, int] = UNSET,
    ...
    exclude_item_ids: Union[Unset, list[UUID]] = UNSET,
    ...
    artist_ids: Union[Unset, list[UUID]] = UNSET,
    album_artist_ids: Union[Unset, list[UUID]] = UNSET,
    contributing_artist_ids: Union[Unset, list[UUID]] = UNSET,
    ...
    studio_ids: Union[Unset, list[UUID]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        exclude_item_ids (Union[Unset, list[UUID]]):
        ...
        artist_ids (Union[Unset, list[UUID]]):
        album_artist_ids (Union[Unset, list[UUID]]):
        contributing_artist_ids (Union[Unset, list[UUID]]):
        ...
        studio_ids (Union[Unset, list[UUID]]):
