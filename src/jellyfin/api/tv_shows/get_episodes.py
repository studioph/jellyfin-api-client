...
def _get_kwargs(
    ...
    *,
    ...
    start_item_id: Union[Unset, UUID] = UNSET,
    ...
    sort_by: Union[Unset, ItemSortBy] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_start_item_id: Union[Unset, str] = UNSET
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        start_item_id (Union[Unset, UUID]):
        ...
        sort_by (Union[Unset, ItemSortBy]): These represent sort orders.
