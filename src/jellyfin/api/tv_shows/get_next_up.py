...
def _get_kwargs(
    *,
    ...
    series_id: Union[Unset, UUID] = UNSET,
    ...
    next_up_date_cutoff: Union[Unset, datetime.datetime] = UNSET,
    enable_total_record_count: Union[Unset, bool] = True,
    disable_first_episode: Union[Unset, bool] = False,
    enable_resumable: Union[Unset, bool] = True,
    enable_rewatching: Union[Unset, bool] = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_series_id: Union[Unset, str] = UNSET
    ...
    json_next_up_date_cutoff: Union[Unset, str] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        next_up_date_cutoff (Union[Unset, datetime.datetime]):
        enable_total_record_count (Union[Unset, bool]):  Default: True.
        disable_first_episode (Union[Unset, bool]):  Default: False.
        enable_resumable (Union[Unset, bool]):  Default: True.
        enable_rewatching (Union[Unset, bool]):  Default: False.
